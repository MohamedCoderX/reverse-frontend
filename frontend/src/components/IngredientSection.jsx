...
const ingredients = [
    {
        name: "Rosemary",
        emoji: new URL('../assets/rosemary.webp', import.meta.url).href,
        angle: 0,
...
• Prevents premature greying: Antioxidants reduce oxidative stress.`,
    ...
    {
        name: "Bhringraj",
        emoji: new URL('../assets/bhringiraj.webp', import.meta.url).href,
        angle: 72,
...
• Soothes scalp: Natural cooling and anti-inflammatory effect.`,
    ...
    {
        name: "Fenugreek",
        emoji: new URL('../assets/fenugreek.webp', import.meta.url).href,
        angle: 144,
...
• Adds shine: Improves overall hair texture.`,
    ...
    {
        name: "Black Seeds",
        emoji: new URL('../assets/blackseed.webp', import.meta.url).href,
        angle: 216,
...
• Regrowth support: Helps with thinning patches.`,
    ...
    {
        name: "Clove",
        emoji: new URL('../assets/clove.webp', import.meta.url).href,
        angle: 288,
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                <div className="relative flex justify-center items-center h-[420px] md:h-[700px]">
                    ...
                    <div className="relative flex justify-center items-center w-full h-full">
                        ...
                        {/* Center Bottle */}
                        <motion.img
                            src={new URL('../assets/ingredient.webp', import.meta.url).href}
